 ...
 */
public class ModelImplVideoOne implements IModelVideoOne{

    @Override
    public void getNewsTitleFromNet(final ModelImplVideoOne.IModelImplGetData iModelImplGetData, String dataId, int type, int time) {
        HttpService init = HttpUtils.init();
        DoLog.doLog(type +"");
        Call<NesOneDataBean> newsGetVideoOneDataBean = init.newsGetVideoOneDataBean(15,5,dataId,type,time);
