 ...
 */
public class ModelImplVideoFour implements IModelVideoFour{
    ...
    public void getNewsTitleFromNet(final IModelImplGetData iModelImplGetData, String dataId, int type, int time) {
        ...
        DoLog.doLog(type +"");
        Call<NesOneDataBean> newsGetVideoOneDataBean = init.newsGetVideoOneDataBean(15,18,dataId,type,time);
