 ...
 */
public class ModelImplVideoThree implements IModelVideoThree{
    ...
    public void getNewsTitleFromNet(final IModelImplGetData iModelImplGetData, String dataId, int type, int time) {
        ...
        DoLog.doLog(type +"");
        Call<NesOneDataBean> newsGetVideoOneDataBean = init.newsGetVideoOneDataBean(15,7,dataId,type,time);
