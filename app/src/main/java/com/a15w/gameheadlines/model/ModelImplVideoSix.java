 ...
 */
public class ModelImplVideoSix implements IModelVideoSix{
    ...
    public void getNewsTitleFromNet(final IModelImplGetData iModelImplGetData, String dataId, int type, int time) {
        ...
        DoLog.doLog(type +"");
        Call<NesOneDataBean> newsGetVideoOneDataBean = init.newsGetVideoOneDataBean(15,21,dataId,type,time);
