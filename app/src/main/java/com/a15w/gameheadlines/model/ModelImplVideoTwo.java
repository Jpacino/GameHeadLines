 ...
 */
public class ModelImplVideoTwo implements IModelVideoTwo{
    ...
    public void getNewsTitleFromNet(final IModelImplGetData iModelImplGetData, String dataId, int type, int time) {
        ...
        DoLog.doLog(type +"");
        Call<NesOneDataBean> newsGetVideoOneDataBean = init.newsGetVideoOneDataBean(15,6,dataId,type,time);
