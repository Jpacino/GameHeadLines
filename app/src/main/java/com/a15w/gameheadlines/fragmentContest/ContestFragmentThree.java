...
import com.a15w.gameheadlines.ui.ContestDtailActivity;
 ...
 */
public class ContestFragmentThree extends Fragment {
    ...
    public static ContestFragmentThree newInstance() {
        return new ContestFragmentThree();
    }
    ...
    private void rxjava(int num) {
        ...
        HttpUtils.init().getContestBean(26, 0, 0, num, "18071adc030d2410d78")
                ...
                .subscribe(new Action1<ContestBean>() {
                    ...
                    public void call(ContestBean contestBean) {
                        ...
                        int num2 = listBeans.size();
                        Collections.reverse(listBeans);
                        myLvAdapter.notifyDataSetChanged();
                        for (int i = 0; i < listBeans.size(); i++) {
                            expandableListView.expandGroup(i);
                        }
                        Log.d(TAG, "call: " + num1 + "----" + num2);
                        if (listbean.isEmpty()) {
        ...
        public View getChildView(final int groupPosition, final int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
            ...
            view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent = new Intent(mContext, ContestDtailActivity.class);
                    intent.putExtra("dataId",listBeans.get(groupPosition).getContent().get(childPosition).getGameId());
    ...
    class ViewHolder {
        ...
        TextView viewsTv;
        @BindView(R.id.child_view_play_btn_tv)
        TextView playBtnTv;
