 ...
 */
public class ContestFragmentFour extends Fragment {
    ...
    public static ContestFragmentFour newInstance() {
        return new ContestFragmentFour();
    }
    ...
    private void rxjava(int num) {
        ...
        HttpUtils.init().getContestBean(8, 0, 0, num, "18071adc030d2410d78")
