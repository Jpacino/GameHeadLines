 ...
 */
public class ContestFragmentOne extends Fragment {
    ...
    public static ContestFragmentOne newInstance() {
        return new ContestFragmentOne();
    }
    ...
    private void rxjava(int num) {
        ...
        HttpUtils.init().getContestBean(25, 0, 0, num, "18071adc030d2410d78")
