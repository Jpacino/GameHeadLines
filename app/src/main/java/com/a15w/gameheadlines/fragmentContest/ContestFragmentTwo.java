 ...
 */
public class ContestFragmentTwo extends Fragment {
    ...
    public static ContestFragmentTwo newInstance() {
        return new ContestFragmentTwo();
    }
    ...
    private void rxjava(int num) {
        ...
        HttpUtils.init().getContestBean(27, 0, 0, num, "18071adc030d2410d78")
