 ...
 */
public class ContestFragmentFive extends Fragment {
    ...
    public static ContestFragmentFive newInstance() {
        return new ContestFragmentFive();
    }
    ...
    private void rxjava(int num) {
        ...
        HttpUtils.init().getContestBean(9, 0, 0, num, "18071adc030d2410d78")
