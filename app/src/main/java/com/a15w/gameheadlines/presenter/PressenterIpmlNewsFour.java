 ...
 */
public class PressenterIpmlNewsFour implements IPressenterNewsTwo , ModelImplNewsTwo.SuccessNewsTwo{
    ...
    public PressenterIpmlNewsFour(IViewNewsOne view, String itemId, int type, int itemData){
        this.view = view;
        model = new ModelImplNewsFour();
