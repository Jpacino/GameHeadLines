 ...
 */
public class PressenterIpmlNewsSix implements IPressenterNewsTwo , ModelImplNewsTwo.SuccessNewsTwo{
    ...
    public PressenterIpmlNewsSix(IViewNewsOne view, String itemId, int type, int itemData){
        this.view = view;
        model = new ModelImplNewsSix();
