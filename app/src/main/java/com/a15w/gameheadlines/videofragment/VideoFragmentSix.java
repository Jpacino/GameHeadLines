...
import com.a15w.gameheadlines.presenter.PressenterIpmlVideoSix;
 ...
 */
public class VideoFragmentSix extends Fragment implements IViewNewsOne{
    ...
    public static VideoFragmentSix newInstance(){
        return  new VideoFragmentSix();
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        PressenterIpmlVideoSix pressenterIpmlNewsOne = new PressenterIpmlVideoSix(this,lastDataId, sType,lastTime);
        pressenterIpmlNewsOne.newsGetTabTitleFromModel();
        sType = sType + 1;
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            @Override
            public void onRefresh() {
                PressenterIpmlVideoSix pressenterIpmlNewsOne = new PressenterIpmlVideoSix(VideoFragmentSix.this,lastDataId,sType,lastTime);
                pressenterIpmlNewsOne.newsGetTabTitleFromModel();
