...
import com.a15w.gameheadlines.presenter.PressenterIpmlVideoOne;
import com.a15w.gameheadlines.presenter.PressenterIpmlVideoThree;
 ...
 */
public class VideoFragmentThree extends Fragment implements IViewNewsOne{
    ...
    public static VideoFragmentThree newInstance(){
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        PressenterIpmlVideoThree pressenterIpmlNewsOne = new PressenterIpmlVideoThree(this,lastDataId, sType,lastTime);
        pressenterIpmlNewsOne.newsGetTabTitleFromModel();
        sType = sType + 1;
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            @Override
            public void onRefresh() {
                PressenterIpmlVideoThree pressenterIpmlNewsOne = new PressenterIpmlVideoThree(VideoFragmentThree.this,lastDataId,sType,lastTime);
                pressenterIpmlNewsOne.newsGetTabTitleFromModel();
