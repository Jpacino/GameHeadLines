 ...
 */
public class VideoFragmentFour extends Fragment implements IViewNewsOne{
    ...
    public static VideoFragmentFour newInstance(){
        return  new VideoFragmentFour();
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        PressenterIpmlVideoFour pressenterIpmlNewsOne = new PressenterIpmlVideoFour(this,lastDataId, sType,lastTime);
        pressenterIpmlNewsOne.newsGetTabTitleFromModel();
        sType = sType + 1;
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            @Override
            public void onRefresh() {
                PressenterIpmlVideoFour pressenterIpmlNewsOne = new PressenterIpmlVideoFour(VideoFragmentFour.this,lastDataId,sType,lastTime);
                pressenterIpmlNewsOne.newsGetTabTitleFromModel();
