...
import com.a15w.gameheadlines.presenter.PressenterIpmlVideoTwo;
 ...
 */
public class VideoFragmentTwo extends Fragment implements IViewNewsOne{
    ...
    public static VideoFragmentTwo newInstance(){
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        PressenterIpmlVideoTwo pressenterIpmlNewsOne = new PressenterIpmlVideoTwo(this,lastDataId, sType,lastTime);
        pressenterIpmlNewsOne.newsGetTabTitleFromModel();
        sType = sType + 1;
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            @Override
            public void onRefresh() {
                PressenterIpmlVideoTwo pressenterIpmlNewsOne = new PressenterIpmlVideoTwo(VideoFragmentTwo.this,lastDataId,sType,lastTime);
                pressenterIpmlNewsOne.newsGetTabTitleFromModel();
