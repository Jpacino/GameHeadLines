 ...
 */
public class VideoFragmentOne extends Fragment implements IViewNewsOne{
    ...
    public static VideoFragmentOne newInstance(){
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        PressenterIpmlVideoOne pressenterIpmlNewsOne = new PressenterIpmlVideoOne(this,lastDataId, sType,lastTime);
        pressenterIpmlNewsOne.newsGetTabTitleFromModel();
        sType = sType + 1;
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            @Override
            public void onRefresh() {
                PressenterIpmlVideoOne pressenterIpmlNewsOne = new PressenterIpmlVideoOne(VideoFragmentOne.this,lastDataId,sType,lastTime);
                pressenterIpmlNewsOne.newsGetTabTitleFromModel();
