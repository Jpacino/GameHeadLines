 ...
 */
public class NewsFragmentFour extends Fragment implements IViewNewsOne{
    ...
    public static NewsFragmentFour newInstance(){
        return new NewsFragmentFour();
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        PressenterIpmlNewsFour pressenterIpmlNewsTwo = new PressenterIpmlNewsFour(this, lastDataId, sType, lastTime);
        pressenterIpmlNewsTwo.newsGetTabTitleFromModel();
        sType = sType + 1;
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            @Override
            public void onRefresh() {
                PressenterIpmlNewsFour pressenterIpmlNewsOne = new PressenterIpmlNewsFour(NewsFragmentFour.this,lastDataId,sType,lastTime);
