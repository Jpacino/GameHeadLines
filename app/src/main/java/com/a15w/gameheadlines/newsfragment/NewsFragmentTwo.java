 ...
 */
public class NewsFragmentTwo extends Fragment implements IViewNewsOne{
    ...
    public static NewsFragmentTwo newInstance(){
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        PressenterIpmlNewsTwo pressenterIpmlNewsTwo = new PressenterIpmlNewsTwo(this, lastDataId, sType, lastTime);
        pressenterIpmlNewsTwo.newsGetTabTitleFromModel();
        sType = sType + 1;
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            @Override
            public void onRefresh() {
                PressenterIpmlNewsOne pressenterIpmlNewsOne = new PressenterIpmlNewsOne(NewsFragmentTwo.this,lastDataId,sType,lastTime);
