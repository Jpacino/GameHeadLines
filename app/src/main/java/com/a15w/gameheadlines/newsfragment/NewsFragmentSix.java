 ...
 */
public class NewsFragmentSix extends Fragment implements IViewNewsOne{
    ...
    public static NewsFragmentSix newInstance(){
        return new NewsFragmentSix();
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        PressenterIpmlNewsSix pressenterIpmlNewsTwo = new PressenterIpmlNewsSix(this, lastDataId, sType, lastTime);
        pressenterIpmlNewsTwo.newsGetTabTitleFromModel();
        sType = sType + 1;
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            @Override
            public void onRefresh() {
                PressenterIpmlNewsSix pressenterIpmlNewsOne = new PressenterIpmlNewsSix(NewsFragmentSix.this,lastDataId,sType,lastTime);
