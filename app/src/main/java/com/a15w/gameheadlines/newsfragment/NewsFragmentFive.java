...
import com.a15w.gameheadlines.presenter.PressenterIpmlNewsFive;
 ...
 */
public class NewsFragmentFive extends Fragment implements IViewNewsOne{
    ...
    public static NewsFragmentFive newInstance(){
        return new NewsFragmentFive();
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        PressenterIpmlNewsFive pressenterIpmlNewsTwo = new PressenterIpmlNewsFive(this, lastDataId, sType, lastTime);
        pressenterIpmlNewsTwo.newsGetTabTitleFromModel();
        sType = sType + 1;
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            @Override
            public void onRefresh() {
                PressenterIpmlNewsFive pressenterIpmlNewsOne = new PressenterIpmlNewsFive(NewsFragmentFive.this,lastDataId,sType,lastTime);
