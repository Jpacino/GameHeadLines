...
import com.a15w.gameheadlines.presenter.PressenterIpmlNewsFour;
import com.a15w.gameheadlines.presenter.PressenterIpmlNewsOne;
import com.a15w.gameheadlines.presenter.PressenterIpmlNewsThree;
import com.a15w.gameheadlines.presenter.PressenterIpmlNewsTwo;
 ...
 */
public class NewsFragmentThree extends Fragment implements IViewNewsOne{
    ...
    public static NewsFragmentThree newInstance(){
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        PressenterIpmlNewsThree pressenterIpmlNewsTwo = new PressenterIpmlNewsThree(this, lastDataId, sType, lastTime);
        pressenterIpmlNewsTwo.newsGetTabTitleFromModel();
        sType = sType + 1;
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            @Override
            public void onRefresh() {
                PressenterIpmlNewsFour pressenterIpmlNewsOne = new PressenterIpmlNewsFour(NewsFragmentThree.this,lastDataId,sType,lastTime);
